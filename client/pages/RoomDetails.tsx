...
const RoomDetails = () => {
  ...
  try {
    ...
    // refresh reviews
    const reviewsData = await api.getReviews("room", room!._id);
    setReviews(reviewsData);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="h-[400px] overflow-hidden rounded-xl shadow-lg relative group">
              <img src={getImageUrl(activeImage)} alt={room.name} className="w-full h-full object-cover transition-all duration-500" />
